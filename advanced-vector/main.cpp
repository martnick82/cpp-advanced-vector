...
void PrintStatement(OBJ&)
{
    cout << "Is Mctor noexcept: "s << std::is_nothrow_move_constructible_v<OBJ>
        << ";   Is Cctor: "s << std::is_copy_constructible_v<OBJ> << endl;
    cout << "DefCtor:   "s << OBJ::def_ctor << "     "s << endl;
    cout << "CopyCtor:   "s << OBJ::copy_ctor << "     "s << endl;
    cout << "MoveCtor:   "s << OBJ::move_ctor << "     "s << endl;
    cout << "CopyAssign:   "s << OBJ::copy_assign << "     "s << endl;
    cout << "MoveAssign:   "s << OBJ::move_assign << "     "s << endl;
    cout << "Dtor:   "s << OBJ::dtor << "     "s << endl;
    cout << "copy_with_val:   "s << OBJ::copy_with_val << "     "s << endl;
    cout << "move_with_val:   "s << OBJ::move_with_val << "     "s << endl;
}
...
void TestEmplaceAdditional_move_noexcept_copy() {
    TestEmplaceAdditionalCopyImpl<CC>(0u, SIZE);
    TestEmplaceAdditionalMoveImpl<CC>(0u, SIZE);
}
